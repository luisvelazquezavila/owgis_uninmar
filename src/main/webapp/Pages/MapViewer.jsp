...
<html xmlns="http://www.w3.org/1999/xhtml" lang="${language}">
    ...
    <body id="bodyClass" class="loadingCursor" >
        ...
        <div style="background-color:#001428; display:flex; align-items:center; justify-content:space-between; padding:1rem 2rem; position:relative; z-index:999999;">

            <!-- Logo UNAM -->
            <div style="flex:1; display:flex; justify-content:flex-start;">
                <a href="https://www.unam.mx/" title="Universidad Nacional Autónoma de México" target="_self">
                    <img src="./common/images/Logos/UNAM.png"
            ...
            <!-- Título -->
            <div style="flex:2; text-align:center; color:white;">
            ...
            <div style="flex:1; display:flex; justify-content:flex-end;">
                <a href="https://www.icmyl.unam.mx/" title="Instituto de Ciencias del Mar y Limnología" target="_self">
                    <img src="./common/images/Logos/ICML.png"
                         alt="Instituto de Ciencias del Mar y Limnología"
                         style="height:60px;" />
                </a>
            </div>
        ...
        <form id="baseForm" class="form-inline" name="baseForm" action=".${names.acdmServlet}" method="post">
            ...
            <%@include file="Layouts/DraggableWindows/HelpTexts/MapInstructions.jsp" %>  <%-- This page has all the calendars, the animaton divs  --%>
                        ...
                        <!-- Canvas universal para animaciones (ERDDAP y ncWMS) -->
            <canvas id="animationCanvas"></canvas>

            <c:if test='${ncwms}'>
                <!--Canvas that contain the currents (solo para ncWMS)-->
            ...
            <c:if test='${ncwms}'>
                ...
                <%@include file="Layouts/DraggableWindows/NcWMS/ZaxisSelection.jsp" %>  
                <%@include file="Layouts/DraggableWindows/NcWMS/Palettes.jsp" %>  
            </c:if>
